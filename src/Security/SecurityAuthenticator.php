...
class SecurityAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    {
        return $this->passwordEncoder->isPasswordValid($user, $credentials['password']) && $user->getAtivo() == true;
    }
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
        ...
        $user = $this->entityManager->getRepository(User::class)->find($token->getUser());
